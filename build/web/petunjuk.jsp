...
<div class="card card-outline-success">
                            ...
                            <h2 class="m-b-0 text-white text-center">Petunjuk Penggunaan</h2>
                            </div>
    <br/>
                            <div class="card-body">
  ...
  <li class="media">
    ...
    <div class="media-body">
      <h5 class="mt-0 mb-1">Berikut cara penggunaan Aplikasi Pencarian Tanaman Obat :</h5>
      &#9830; Kata pertama dalam kalimat pencarian harus merupakan objek yang dicari. Misal :Tanaman, manfaat, klasifikasi dst.<br/>
      &#9830; Kata kedua merupakan sebuah kata kerja atau kata hubung. Kata kerja misal: mengobati, menyembuhkan. Kata hubung misal : untuk, yang dst. <br/>
      &#9830; Kata selanjutnya merupakan sebuah keterangan dari objek yang akan dicari. Misal :untuk penyakit (diabetes, malaria), daerah (Jawa, Kalimantan).
    </div>
  </li>
<!--  <li class="media my-4">
