...
<body class="fix-header fix-sidebar">
    ...
    <div class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-white border-bottom box-shadow">
      ...
      <nav class="my-2 my-md-0 mr-md-3">
        <a class="p-2 text-dark" href="#">Daftar Tanaman</a>
        <a class="p-2 text-dark" href="#">Petunjuk Penggunaan</a>
...
<div class="card card-outline-success">
                            ...
                            <h2 class="m-b-0 text-white text-center">Tanaman</h2>
                            </div>
    <br/>
...
<input id='show_hide' type='button' value='Show More' onclick="toggle()" "></button>
<span id='btn' style='display:none'>
                                                                          <p> 
                                                                          Klasifikasi           :<br>
                                                                          Habitat               :<br>
                                                                          Habitus               :<br>
                                                                          Tingkat Kelembaban    :<br>
                                                                          Tanaman Daerah        :<br>
                                                                          Etnis Pengguna        :<br>
                                                                          </p>
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-bordered">
                                  <thead>
                                    <tr>
                                      <th scope="col">No</th>
                                      <th scope="col">Bagian yang digunakan</th>
                                      <th scope="col">Manfaat Obat </th>
